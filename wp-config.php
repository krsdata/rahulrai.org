...
define('DB_NAME', 'rahulrai_db');

/** MySQL database username */
define('DB_USER', 'rahulrai_user');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '|yX{EY[:bP9,3tO-aM[*0o:+ 9nd5sTT+n*SssrB2zyN_jQ2<M{A+K+|z-l} 8)z');
define('SECURE_AUTH_KEY',  'kS60cbpuMy@MgmP^X~7vWV|>SJ1M,{#Mk@P=sf8$xQ!M0#g@g[scd]S)h!yXgkj1');
define('LOGGED_IN_KEY',    'qFJ4qKYbnf8/9:H7h2kj%|jyb4H EZ1tgj}KIESN/A7I4=YT6_A?9y@Hha]p;]z(');
define('NONCE_KEY',        'O}W]L0.S=]SWXfEHf,hM0adx4fglG/ mbX5C1=<z3r %[?b[|HJrLu0*SJZz>+<^');
define('AUTH_SALT',        'tpIP;nh1k#ow!Da/WDw4!rdu,v/U(b54z&u8o/o9WA-zb%?+hA^~,/-~oa=f&g{|');
define('SECURE_AUTH_SALT', 'p1?vch92]%%{.1vi#(1`!Mvtt=G4G1vl`1gigX1L,>x-yD1pO7{0B{4nQ,-fugo)');
define('LOGGED_IN_SALT',   'gUeA(j,+,)U,`3DB)]*XLo~~^Gwb*~d,h|G{RU}:;`a #g_qt t8 vS`YqA<y[p?');
define('NONCE_SALT',       ';4Lp+<HqQGqFG6qGxtxMtPF:LLQ`QW1!^<(+Gy/LeYF6!iv{q6Tk1#HN0L4Ox3bq');
