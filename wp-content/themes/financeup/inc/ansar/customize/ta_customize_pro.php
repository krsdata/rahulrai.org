...
function financeup_pro_customizer( $wp_customize ) {
    ...
    */
    ...
    $wp_customize->add_section( 'financeup_pro_section' , array(
		'title' => __('Themeansar Store', 'financeup'),
		'priority' => 2100,
   	) );
...
class financeup_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="ta-pro-box">
	 <a href="<?php echo esc_url( __('https://themeansar.com/docs/wp/financeup-lite/', 'financeup'));?>" target="_blank" class="document" id="review_pro"><?php _e( 'Online Documenation','financeup' ); ?></a>
