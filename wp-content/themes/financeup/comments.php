...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One Comments &ldquo;%2$s&rdquo;', '%1$s Comments', get_comments_number(), 'comments title', 'financeup' ) ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'financeup' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'financeup' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'financeup' ) ); ?></div>
	...
	if ( ! comments_open() && get_comments_number() && post_typefinanceupupports( get_post_type(), 'comments' ) ) : ?>

		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'financeup' ); ?></p>
	<?php
	endif;
	comment_form();
	?>
