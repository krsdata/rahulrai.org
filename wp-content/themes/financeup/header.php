    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12 col-sm-6">
         <ul class="info-right">
          <li>
              <?php if( class_exists('woocommerce')) { ?><a href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart','financeup' ); ?>" class="ta-cart"> <i class="fa fa-shopping-bag"></i><span class="ta-cart-count"> <span class="ta-cart-item"><?php echo sprintf (_n( '%d', '%d', WC()->cart->cart_contents_count ), WC()-> cart->cart_contents_count ); ?> </span>  </span></a> <?php } ?>
          </li>
        </ul>
