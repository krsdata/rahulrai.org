 ...
 * @access public
 */
class Mercantile_Customize_Section_Pro extends WP_Customize_Section {
		...
		<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
			...
			<h3 class="accordion-section-title">
				...
				<# if ( data.pro_text && data.pro_url ) { #>
					<a href="{{ data.pro_url }}" class="button at-pro button-secondary alignright" target="_blank">{{ data.pro_text }}</a>
				<# } #>
			</h3>
		</li>
	<?php }
