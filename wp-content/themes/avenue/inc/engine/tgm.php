...
add_action( 'tgmpa_register', 'avenue_register_required_plugins' );
/**
 ...
 */
function avenue_register_required_plugins() {
    /**
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'notice_can_activate_recommended' => _n_noop( 'Avenue theme recommends using this plugin, which is currently inactive: %1$s.', 'Avenue theme recommends using these plugins, which are currently inactive: %1$s.' ), // %1$s = plugin name(s).
