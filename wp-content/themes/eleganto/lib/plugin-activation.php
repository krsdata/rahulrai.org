...
function eleganto_register_required_plugins() {
	...
	$plugins = array(
		array(
			'name'				 => esc_html__( 'Kirki Toolkit', 'eleganto' ),
			'slug'				 => 'kirki',
			'version'			 => '2.3.7',
			'required'			 => false,
		...
		array(
			'name'               => esc_html__( 'Portfolio Post Type', 'eleganto' ),
		...
		array(
			'name'				 => esc_html__( 'Eleganto Advanced Sections', 'eleganto' ),
			'slug'				 => 'eleganto-advanced-sections',
			'version'			 => '1.1.5',
			'required'			 => false,
			'force_activation'	 => false,
			'force_deactivation' => false,
		...
		array(
			'name'				 => esc_html__( 'Contact Form 7', 'eleganto' ),
			'slug'				 => 'contact-form-7',
			'version'			 => '4.4',
			'required'			 => false,
			'force_activation'	 => false,
