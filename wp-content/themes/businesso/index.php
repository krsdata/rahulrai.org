				...
				<div class="clear"></div>
				   <div class="blog-post-title">
					<div class="blog-post-title-wrapper">
						...
						<p><?php echo get_slider_excerpt(); ?></p>
						<div class="btn-left-area">
					      <a  href="<?php the_permalink(); ?>" class="main-btn btn-more btn-left">More</a>
					  </div>
					</div>
				</div>	
			  </div>
